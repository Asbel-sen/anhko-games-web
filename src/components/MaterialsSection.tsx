...
const materials = [
  { icon: KeyRound, name: "Llaveros del juego", available: true },
  { icon: CreditCard, name: "Tarjetas coleccionables", available: true },
  { icon: FileText, name: "Folletos informativos", available: true },
  { icon: Image, name: "Cartel oficial", available: true },
  { icon: Video, name: "Video promocional", available: true },
];
      ...
      <div className="container px-4 md:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">
            <span className="text-foreground">Material para la </span>
            <span className="gradient-text">Feria</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
          {materials.map((item, index) => (
            <div
              key={item.name}
              className="card-cyber rounded-xl p-6 group hover:border-primary/50 transition-all duration-300"
            >
