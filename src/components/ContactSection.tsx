import { Mail, QrCode, Instagram, Facebook } from "lucide-react";
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4 border-t border-border">
                  ...
                  <div className="flex gap-4">
                    <a href="#" className="w-12 h-12 rounded-lg bg-muted/50 border border-border flex items-center justify-center hover:border-primary hover:bg-primary/10 transition-all duration-300 group">
